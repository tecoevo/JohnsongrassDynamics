%% Generation of data for control regime figure
...
control(:, :, 13) = [zeros(1, n_years+1); zeros(1, n_years+1); ...
                    ones(1, n_years+1)];
...
for i = 1:n_rep
    ...
    [P, R, SB, P_dens] = ...
        stochasticDynamics_TwoHerbicides_densityDependance(A(i1), p_self, ...
...
writetable(T, strcat('Table_TwoHerbicides_Stochastic_control', num2str(i10), ...
