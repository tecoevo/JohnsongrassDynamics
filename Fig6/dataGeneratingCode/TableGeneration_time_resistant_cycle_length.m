...
% with ACCase- and ALS-inhibitor with same efficacy cycled depending on 
% the cycle length and the proportion of simulated populations in whish 
...
writetable(T, 'Table_Stochastic_Resistance_CycleLength');