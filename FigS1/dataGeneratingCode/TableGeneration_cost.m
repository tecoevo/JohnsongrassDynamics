%% Generation of data for R allele frequency cost figure
...
[P, R, SB, P_dens] = Dynamics_densityDependance(A, p_self(i1),...
    S0, R0, dens0, control(2, :, i7), control(1, :, i7), seeds(i2), bank(i3), ...
