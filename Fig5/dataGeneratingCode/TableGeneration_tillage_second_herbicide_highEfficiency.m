...
[P, R, SB, P_dens] = ...
    Dynamics_densityDependance_twoHerbicides_highEfficiency(A(i1), p_self, ...
...
writetable(T, strcat('Table_TwoHerbicides_Deterministic_HighEfficiency_control', ...
